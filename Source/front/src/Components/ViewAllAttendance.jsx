...
const ViewAllAttendance = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:3000/auth/getAllAttendance/${id}`)
      .then(res => {
      ...
      <div className="row flex-nowrap">
        ...
        <div className="col p-0 m-0">
          <div className="d-flex align-items-center justify-content-center ">
            ...
            <ViewAllButton onClick={handleViewReq}>
            ...
            <tbody>
              {attendance.map(record => (
                <tr key={record.id}>
                  ...
                  <Td>{record.status}</Td>
                  <Td>
                    <AcceptButton onClick={() => handleAction(record.id, record.date, 'P')}>Present</AcceptButton>
                    <DeclineButton onClick={() => handleAction(record.id, record.date, 'A')}>Absent</DeclineButton>
                  </Td>
                </tr>
              ))}
            </tbody>
